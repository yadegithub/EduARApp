...
const hotspotLabelCopy: Record<string, Record<AppLanguage, string>> = {
  Aorta: { en: "Aorta", ar: "الشريان الأبهر", fr: "Aorte" },
  Ventricle: { en: "Ventricle", ar: "البطين", fr: "Ventricule" },
  Atrium: { en: "Atrium", ar: "الأذين", fr: "Oreillette" },
  Trachea: { en: "Trachea", ar: "القصبة الهوائية", fr: "Trachée" },
  "Left lung": { en: "Left lung", ar: "الرئة اليسرى", fr: "Poumon gauche" },
  Bronchi: { en: "Bronchi", ar: "الشعب الهوائية", fr: "Bronches" },
  Sun: { en: "Sun", ar: "الشمس", fr: "Soleil" },
  "Inner orbit": { en: "Inner orbit", ar: "المدار الداخلي", fr: "Orbite interne" },
  "Gas giant": { en: "Gas giant", ar: "عملاق غازي", fr: "Géante gazeuse" },
  Battery: { en: "Battery", ar: "البطارية", fr: "Pile" },
  Switch: { en: "Switch", ar: "المفتاح", fr: "Interrupteur" },
  Bulb: { en: "Bulb", ar: "المصباح", fr: "Ampoule" },
  "North pole": { en: "North pole", ar: "القطب الشمالي", fr: "Pôle nord" },
  "Field arc": { en: "Field arc", ar: "قوس المجال", fr: "Arc de champ" },
  "South pole": { en: "South pole", ar: "القطب الجنوبي", fr: "Pôle sud" },
  Pivot: { en: "Pivot", ar: "نقطة التعليق", fr: "Pivot" },
  "Swing path": { en: "Swing path", ar: "مسار التأرجح", fr: "Trajectoire" },
  Bob: { en: "Bob", ar: "الثقل", fr: "Masse" },
  "Temple roof": { en: "Temple roof", ar: "سقف المعبد", fr: "Toit du temple" },
  "Column hall": { en: "Column hall", ar: "قاعة الأعمدة", fr: "Salle à colonnes" },
  Artifact: { en: "Artifact", ar: "قطعة أثرية", fr: "Artéfact" },
  "Plate edge": { en: "Plate edge", ar: "حافة الصفيحة", fr: "Bord de plaque" },
  "Mantle flow": { en: "Mantle flow", ar: "تدفق الوشاح", fr: "Flux du manteau" },
  Subduction: { en: "Subduction", ar: "الاندساس", fr: "Subduction" },
};
