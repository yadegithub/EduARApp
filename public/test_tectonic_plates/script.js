...
const MARKER_LOST_GRACE_FRAMES = 32;
...
const defaultAnatomyParts = [
    {
        ...
        info: "A convergent boundary forms where two tectonic plates move toward each other.",
        hint: "Watch the collision zone to see how crust can fold, rise, or sink.",
    ...
    },
    {
        ...
        info: "Subduction happens when one plate dives beneath another into the mantle.",
        hint: "This downward motion can create trenches, volcanoes, and earthquakes.",
    ...
    },
    {
        ...
        label: "Uplift",
        title: "UPLIFT",
        info: "Uplift raises crustal material as plates compress and deform the surface.",
        hint: "Mountain ranges often grow slowly from repeated uplift.",
    ...
    },
    {
        ...
        label: "Oceanic Plate",
        title: "OCEANIC PLATE",
        info: "Oceanic plates are dense sections of lithosphere that can sink below lighter crust.",
        hint: "Density helps explain why one plate may slide underneath another.",
        normalizedPosition: [-0.02, -0.02, 0.31]
    },
    {
        id: "continental-plate",
        label: "Continental Plate",
        title: "CONTINENTAL PLATE",
        info: "Continental plates are thicker and less dense, so they often crumple and rise during collision.",
        hint: "Compression along these edges can build high terrain.",
        normalizedPosition: [0.08, -0.18, 0.22]
    },
    {
        id: "earthquake-focus",
        label: "Earthquake Focus",
        title: "EARTHQUAKE FOCUS",
        info: "Earthquakes begin where stress suddenly releases along a plate boundary.",
        hint: "The strongest shaking usually follows active faults near moving plates.",
...
const defaultCopy = {
    ...
    statusLoading: "Loading tectonic plates model...",
    statusReady: "Camera ready",
    statusTracking: "Tectonic plates placed",
    ...
    statusModelError: "The tectonic plates model could not be loaded.",
    focusTag: "Plate boundary",
    overview: {
        tag: "Geography model",
        title: "TECTONIC PLATES",
        info: "Tap a numbered marker to understand collision, subduction, uplift and earthquake activity.",
        hint: "Use Rotate, Scale and Labels to inspect the plate boundary more clearly."
    }
};
    ...
    content: {
        defaultPart: {
            en: {
                tag: "Geography model",
                name: "TECTONIC PLATES",
                info: "Inspect tectonic plates in AR and tap the numbered labels to learn how plate collisions shape Earth's surface.",
...
async function startCamera(config) {
    ...
    try {
        ...
        console.error("Tectonic plates QR session failed to start.", error);
...
async function runQrDetection() {
    ...
    try {
        ...
        console.error("Tectonic plates QR scan failed.", error);
    } finally {
